const homePage = {
    title : 'FileMakr: Project Report and Source Code for Final Year College Students',
    description:'Access project reports and source code for B.Tech, M.Tech, B.E., M.E., BCA, and MCA final year students using FileMakr. Explore a wide range of projects with code and documentation for web development.',
    author:'https://www.filemakr.com',
    abstract:'FileMakr is a database management system that can be used by final year college students for their projects.It provides a platform for students to create their own project report.he system can be used by B.tech, M.tech, BCA, and MCA students. FileMakr offers project reports and source code for students to use in their final year projects.',
    keywords:'PHP Projects with Source Code, Source Code, Java, Python, Project Report, Final Year Projects, Filemakr',
...
const blogPage = {
    title: 'Final Year Project Ideas & Solutions for B.Tech, BCA, MCA Students | FileMakr',
    description: "Feeling the pressure of your final year project? Discover ready-to-submit project reports and source code for B.Tech, BCA, MCA, M.Tech, B.E., M.E. students in India. From MERN stack e-commerce apps to AI/ML, find your shortcut to top marks with IEEE-standard documentation and expert guidance at FileMakr.",
    author: 'https://www.filemakr.com', // Should ideally be your brand name or the author's name, not just the base URL if it's a blog post. If FileMakr is the "authoring entity", then it's fine.
    abstract: 'Navigating your final year project can be daunting, but it doesn\'t have to be! FileMakr provides comprehensive, ready-to-use project reports and source code tailored for B.Tech, M.Tech, B.E., M.E., BCA, and MCA students across India. Whether you need a full-stack MERN e-commerce app, a cutting-edge AI/ML solution, or a robust data management system, our platform offers high-quality, IEEE-standard documentation and working code to help you achieve top academic success. Skip the stress, save time, and submit with confidence!',
    keywords: 'final year projects, B.Tech projects, BCA projects, MCA projects, M.Tech projects, B.E. projects, M.E. projects, project reports, source code, MERN stack project, e-commerce project, payment gateway project, IEEE project report, ready-made projects, project with documentation, computer science projects, IT projects, engineering projects, academic projects, project help, India projects, FileMakr',
    url: 'https://filemakr.com/blog' // This should be the specific URL of the blog post.
};
...
const sourcePage = {
    title : 'Source Code for Final Year Projects — PHP, Java, Python, Node.js | FileMakr',
    description:'Download ready-to-run source code for B.Tech, M.Tech, BCA, MCA final year projects. PHP, Java, Python, Node.js, MERN stack with database and documentation.',
    author:'https://www.filemakr.com',
    abstract:'FileMakr provides source code for final year projects across PHP, Java, Python, Node.js. Easy setup, full documentation, and database included for engineering and CS students.',
    keywords:'source code, final year project code, PHP projects, Java projects, Python projects, Node.js, MERN stack, project source code, FileMakr',
