...
(err,result)=>err ? console.log(err) : res.render('B.Tech/index',{result:result,Metatags:onPageSeo.homePage,CommonMetaTags:onPageSeo.commonMetaTags,category:req.categories,fullUrl:req.fullUrl,graduation_type_send:'B.Tech',active:'report',navOnly:true}))
})
