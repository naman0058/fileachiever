...
var affiliate = require('./routes/Affiliation/index')
var freelancing = require('./routes/Freelancing/index')
var shopkeeper = require('./routes/Shopkeeper/index');

var ieee = require('./routes/ieee/ieeeproject')
var affiliateconfig = require('./routes/Affiliation/config');
require('./routes/leaderboardCron'); // ✅ cleaner
//var facebooklogin = require('./routes/facebooklogin');

var manishaRouter = require('./subdomains/manisha')
var affiliateBlog = require('./routes/Affiliation/blog');
...
app.use(express.static(path.join(__dirname, 'public'),{
  maxAge: '31536000' // Cache-Control max-age in seconds
}));
...
app.use('/affiliate/config',affiliateconfig)
app.use('/affiliateblog',affiliateBlog);
